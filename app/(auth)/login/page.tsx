        ...
        <div className="relative z-10 max-w-lg">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <p className="font-semibold text-foreground">Portfolio Growth</p>
                <p className="text-sm text-muted-foreground">Last 30 days</p>
              </div>
            </div>
            <div className="flex items-end gap-2 mb-4">
              <span className="text-4xl font-bold text-foreground">$124,532</span>
              <span className="text-primary font-semibold mb-1">+24.5%</span>
            </div>
